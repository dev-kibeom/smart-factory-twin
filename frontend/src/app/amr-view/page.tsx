...
export default function AmrViewDashboard() {
  const [workOrderNum, setWorkOrderNum] = useState('WO-2026-001');
  ...
  return (
    <main className="min-h-screen bg-slate-900 text-slate-100 p-8 font-sans">
      ...
      {/* 3대 엔지니어링 도메인 분산 레이아웃 매핑 */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        
        {/* 좌측: 생산 제어 및 작업 지시 트랜잭션 수립 패널 (ISA-95 IT Plane) */}
        ...
        {/* 우측 상단/하단 혼합: WebRTC 초저지연 미디어 평면 및 OEE 시계열 차트 */}
